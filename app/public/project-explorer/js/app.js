...
if (window.location.href.includes('register.html')) {
    window.onload = function () {
        ...
        // Populating the graduation year
        const graduationYear = document.getElementById("inputState");
        ...
        fetch("/api/graduationYears")
            ...
            .then((data) => {
                graduationYear.options.length = 0
        ...
        const myAlert = document.getElementById("errormsg")
        ...
        function handleSubmit(event) {
            ...
            let regInfo = {
                ...
                graduationYear: document.getElementById("inputState").value,
            }
...
// Update Navbar
const every = document.getElementById("logOut");
...
if (window.location.href.includes('createproject.html')) {
    window.onload = function () {
        ...
        const myAlert = document.getElementById("error-alert")
        myAlert.style.display = "none";
